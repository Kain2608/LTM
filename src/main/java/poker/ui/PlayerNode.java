...
public class PlayerNode extends VBox {
    ...
    public PlayerNode(Player player, int visualSeatPosition, String levelStr, String flagStr) {
        ...
        this.setPadding(new javafx.geometry.Insets(5, 8, 5, 8));
        ...
        chipsLabel.setStyle("-fx-text-fill: #67d8ff; -fx-font-weight: bold; -fx-font-size: 12px; " +
                "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.8), 3, 0, 0, 1);");

        infoBox.setAlignment(Pos.CENTER);
        infoBox.setMinWidth(112);
        infoBox.setStyle("-fx-background-color: linear-gradient(to bottom, rgba(18,29,39,0.96), rgba(6,13,20,0.96)); " +
                "-fx-padding: 5 12; -fx-background-radius: 9; -fx-border-color: rgba(212,175,55,0.32); " +
                "-fx-border-radius: 9; -fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.55), 7, 0, 0, 2);");
